...
urlpatterns = patterns('',
    ...
    url(r'^upload_background/$', views.upload_background),
    ...
    url(r'^picture_list/$', views.picture_list),
    url(r'^delete_background_image/(\d+)/$', views.delete_background_image),
    url(r'^edit_background_image/(\d+)/$', views.edit_background_image),
    url(r'^delete_picture_image/(\d+)/$', views.delete_picture_image),
    url(r'^edit_picture_image/(\d+)/$', views.edit_picture_image),
